...
public class ZbTRoomPlan implements Serializable {
    ...
    private Integer incomeAmountToday;
    ...
    public Integer getIncomeAmountToday() {
        return incomeAmountToday;
    }

    public void setIncomeAmountToday(Integer incomeAmountToday) {
        this.incomeAmountToday = incomeAmountToday;
    }
}