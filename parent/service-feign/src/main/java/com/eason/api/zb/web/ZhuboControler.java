...
public class ZhuboControler {
    ...
    public ResponseVo changeRoom(HttpServletRequest request,  @RequestBody  StartPlayRequestVo startPlayRequestVo) {
        try {
            Integer userId=null;
            String api_token=request.getHeader("api_token");
            if (StringUtils.isEmpty(api_token)){
            ...
            ResponseVo responseVo = new ResponseVo(0, "操作成功");
            responseVo.setData(zhuboServiceImpl.changeRoom(userId, startPlayRequestVo));
            return responseVo;
        } catch (ServiceException e) {
            ResponseVo responseVo = new ResponseVo(401, e.getMessage());
            responseVo.setData(new HashMap<>());
    ...
    public ResponseVo getConfigInfo(HttpServletRequest request) {
        try {
            Integer userId=null;
            String api_token=request.getHeader("api_token");
            if (StringUtils.isEmpty(api_token)){
            ...
            ResponseVo responseVo = new ResponseVo(0, "操作成功");
            responseVo.setData(zhuboServiceImpl.getConfigInfo(userId,api_token));
            return responseVo;
        } catch (ServiceException e) {
            ResponseVo responseVo = new ResponseVo(401, e.getMessage());
            responseVo.setData(new HashMap<>());
    ...
    public ResponseVo getReadyPlayInfo(HttpServletRequest request) {
        try {
            ...
            ResponseVo responseVo = new ResponseVo(0, "操作成功");
            ReadyPlayResponseVo readyPlayResponseVo=zhuboServiceImpl.getReadyPlayInfo(userId,api_token);
