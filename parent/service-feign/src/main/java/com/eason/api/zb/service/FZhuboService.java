...
public interface FZhuboService extends IZhuboService {
    ...
    @RequestMapping(value = "/zhubo/getConfigInfo", method = RequestMethod.GET)
    ReadyPlayResponseVo getConfigInfo(@RequestParam(value = "userId") Integer userId, @RequestParam(value = "token") String token) throws ServiceException;

    @RequestMapping(value = "/zhubo/changeRoom", method = RequestMethod.POST)
    StartPlayResponseVo changeRoom(@RequestParam(value = "userId") Integer userId, @RequestBody StartPlayRequestVo startPlayRequestVo) throws ServiceException;
